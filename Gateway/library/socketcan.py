...
class socketcanif(Thread,msgbus):
    ...
    def CANframing(self,canbus,canID,data):
        newlist = []
        canframe = []
        print('TX',canID,data)
        msg = 'Send Frame'
